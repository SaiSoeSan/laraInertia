...
const form = useForm({
  ...
  position_title: props.jobApplication.position_title,
...
const submit = () => {
  form.put(
    route("job-applications.update", {
      job_application: props.jobApplication.id,
    })
  );
};
...
<template>
  <Head
    :title="`Edit: ${jobApplication.company_name} - ${jobApplication.position_title}`"
  />
